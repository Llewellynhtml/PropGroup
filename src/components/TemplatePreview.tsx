...
export default function TemplatePreview({ config, property, agent: agentProp, branding: brandingProp }: Props) {
  ...
  const containerStyle: React.CSSProperties = {
    width: `${width}px`,
    height: `${height}px`,
    backgroundColor: branding.background_color_hex || '#FFFFFF',
    color: branding.primary_color_hex || branding.primary_color || '#000000',
    fontFamily: branding.body_font_family || 'sans-serif',
    position: 'relative',
    overflow: 'hidden',
    display: 'flex',
  ...
  const getHeadlineStyle = (): React.CSSProperties => {
    const base: React.CSSProperties = {
      fontFamily: branding.heading_font_family || 'serif',
      color: branding.primary_color_hex || branding.primary_color || '#000000',
      lineHeight: '1.1',
      fontWeight: 800,
    };
